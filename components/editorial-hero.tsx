...
export function EditorialHero({
  ...
  return (
    <section className="mx-auto max-w-page px-6 pt-16 pb-12 md:pt-24 md:pb-16">
      ...
      {imageUrl && (
        <div className="relative mt-12 aspect-[16/9] w-full overflow-hidden bg-ink/5 md:mt-16">
          <Image
            src={imageUrl}
            alt={imageAlt ?? ""}
            fill
