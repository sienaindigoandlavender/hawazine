...
// Centred serif title with a magazine-style byline block beneath it:
// date, words, photography, share icons. Each on its own row, each
// quiet and small enough that the title still leads.
export function JournalEntryHeader({ entry }: { entry: JournalEntry }) {
  return (
    <header className="mx-auto max-w-page px-6 pt-16 pb-10 md:pt-24">
      ...
      <div className="mt-10 flex flex-col items-center gap-1 font-sans text-meta text-quiet">
